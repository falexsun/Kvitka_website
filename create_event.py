...
with open('kvitka-light.html') as f:
    main_content = f.read()

# Extract top and bottom
top = main_content.split('<!-- HERO -->')[0]
bottom = '<!-- FLOAT CTA -->' + main_content.split('<!-- FLOAT CTA -->')[1]

# Make sure top links on inner page point to kvitka-light.html
nav_replacements = [
    ('href="#news"', 'href="kvitka-light.html#news"'),
    ('href="#video"', 'href="kvitka-light.html#video"'),
    ('href="#gallery"', 'href="kvitka-light.html#gallery"'),
    ('href="#bio"', 'href="kvitka-light.html#bio"'),
    ('href="#initiatives"', 'href="kvitka-light.html#initiatives"'),
    ('href="#press"', 'href="kvitka-light.html#press"')
]
    ...
    <aside class="event-sidebar">
      <div class="sidebar-widget">
        ...
        <ul class="recent-list">
          <li>
            <a href="event.html">Участие в пленарном заседании ГД ФС РФ по вопросам бюджета</a>
            <div class="recent-date">05 МАЯ 2026</div>
          </li>
          <li>
            <a href="event.html">Поздравление ветеранов с Днем Великой Победы</a>
            <div class="recent-date">09 МАЯ 2026</div>
          </li>
          <li>
            <a href="event.html">Открытие нового образовательного кластера</a>
            <div class="recent-date">28 АПР 2026</div>
          </li>
        </ul>
      </div>
...
# Update some hrefs in kvitka-light.html to point to event.html
main_content = main_content.replace('class="n-card rv" href="#"', 'class="n-card rv" href="event.html"')
main_content = main_content.replace('class="n-card rv mix-reception" href="#"', 'class="n-card rv mix-reception" href="event.html"')
main_content = main_content.replace('class="n-card rv mix-law" href="#"', 'class="n-card rv mix-law" href="event.html"')
main_content = main_content.replace('class="n-card rv mix-speech" href="#"', 'class="n-card rv mix-speech" href="event.html"')

with open('kvitka-light.html', 'w') as f:
    f.write(main_content)

# Update some hrefs in albums.html to point to event.html
with open('albums.html') as f:
    alb_content = f.read()
alb_content = alb_content.replace('class="album-card rv" href="#"', 'class="album-card rv" href="event.html"')
